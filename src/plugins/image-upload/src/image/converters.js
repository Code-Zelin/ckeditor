 ...
 * @returns {Function}
 */
export function downcastSrcsetAttribute( imageUtils ) {
	return dispatcher => {
		dispatcher.on( `attribute:srcset:imageBlock`, converter );
	};
 ...
 * @returns {Function}
 */
export function downcastImageAttribute( imageUtils, attributeKey ) {
	return dispatcher => {
		dispatcher.on( `attribute:${ attributeKey }:imageBlock`, converter );
	};
