...
export default class ImageBlockEditing extends Plugin {
	...
	_setupConversion() {
		...
		conversion.for( 'downcast' )
			.add( downcastImageAttribute( imageUtils, 'src' ) )
			.add( downcastImageAttribute( imageUtils, 'alt' ) )
			.add( downcastSrcsetAttribute( imageUtils ) );

		// More image related upcasts are in 'ImageEditing' plugin.
		conversion.for( 'upcast' )
			.elementToElement( {
				view: getImgViewElementMatcher( editor ),
