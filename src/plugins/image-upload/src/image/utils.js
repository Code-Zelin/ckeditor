 ...
 */
export function getImgViewElementMatcher( editor ) {
	const imageUtils = editor.plugins.get( 'ImageUtils' );
	const areBothImagePluginsLoaded = editor.plugins.has( 'ImageBlockEditing' );
 ...
 * (`'imageBlock'`) that will make most sense from the UX perspective if a new
